...
const ItemsCard = ({item}) => {
    ...
    const {item_name, subcategory, price, rating, process_time, description, customization, stock_state, user_name, user_email, photo} = item;
    ...
    return (
        ...
        <div className="card-body gap-0 w-3/5 bg-orange-300">
            <div className="flex items-center justify-between">
                ...
                <button className=" font-bold border-2 border-teal-700 px-2 rounded hover:bg-teal-400 hover:text-white duration-200">View</button>
            </div>
